...
**ช่วงเวลาที่ผ่านไปแล้ว**: ระบบตัดสล็อตของ "วันนี้" (คำนวณเป็นเวลาไทย UTC+7 ผ่าน `_now_th()` ใน `nail.py`) ที่เวลาผ่านไปแล้วออกจากรายการอัตโนมัติ ทั้งฝั่งแสดงผล (`/slots`) และฝั่งป้องกันการจอง (`/booking/hold`)
